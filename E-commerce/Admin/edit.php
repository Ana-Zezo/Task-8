...
keyAndValueSession("update_error", "title");
keyAndValueSession("update_error", "desc");
...
if (isset($_GET["id"])) {
    ...
    foreach ($categories as $key => $item) {
        if ($categories[$key]["id"] == $_GET["id"]) {
            $myArr = $categories[$key];
        }
    }
} else {
    $_SESSION["not_found"] = "Page Not Found";
    echo "<a href='./displayCategories.php' class='btn btn-primary'>Go Back</a>";
    die;
}
?>

<div class="container">
    <form action="./controller/UpdateController.php?id=<?= $myArr["id"] ?>" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control border px-3" id="title"
                                        placeholder="Enter Name" name="title" value="<?= $myArr["title"] ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control border px-3" id="desc"
                                        placeholder="Enter Description" name="desc" value="<?= $myArr["desc"] ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <div class="mb-3">
                                        ...
                                        <img src="img/<?= $myArr['image'] ?>" width="75" height="75" class="mt-2"
                                            alt="">
